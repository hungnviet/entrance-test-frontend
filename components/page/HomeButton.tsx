...
export function HomeButton() {
  ...
  return (
    <Button className="mb-4 font-bold text-xl text-black dark:text-white bg-transparent border-none hover:bg-transparent hover:cursor-pointer" variant="ghost" onClick={handleClick}>
